...
/*    for (int i = 0; i < 5; i++)
    ...
    cout << "Starting fuzzy search with " << selectedCommand << endl;
    //try
    //{
    //    long long int hitCount = NW->fuzzysearchTheQueries(selectedCommand);
    //}
    ...
    BL->fuzzysearchTheQueries("RANDOM");
    
    cout << "Total hits with up to 2 missmatches " << BL->hitCount;
